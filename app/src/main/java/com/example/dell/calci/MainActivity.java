    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_cos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Double d4=Math.cos(Math.toRadians(d3));
        ...
        btn_tan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String s4=ed1.getText().toString();
                Double d5=Double.parseDouble(s4);
                Double d6=Math.tan(Math.toRadians(d5));
                String s6=Double.toString(d6);
                ed1.setText(s6);
        ...
        btn_calc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mAddition == true){
                    ...
                    ed1.setText(Float.toString(Value1 + Value2 ));
                    mAddition=false;
                }
